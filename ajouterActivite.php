...
if (		
    isset($_POST["id_a"])&&isset($_POST["titre_a"])&&isset($_POST["description_a"])&&isset($_POST["categorie_a"])&&isset($_POST["description_a"])&&isset($_POST["prix_a"])&&isset($_POST["date_a"]))
{
  if ( !empty($_POST["id_a"])&& !empty($_POST["titre_a"])&& !empty($_POST["description_a"])&& !empty($_POST["categorie_a"])&& !empty($_POST["prix_a"])&& !empty($_POST["date_a"]))
  {
      $Activite = new Activite
      ($_POST["id_a"],$_POST["titre_a"],$_POST["description_a"],$_POST["categorie_a"],$_POST["prix_a"],$_POST["date_a"]);
      $Activitec->Ajoutera($Activite);
      header("Location:afficherActivite.php?successMessage= Activité ajoute avec succes");  
  } 
  else
  {
    echo $errorMessage = "<label id = 'form' style = 'color: red; font-weight: bold; text-align: center; display: flex;float: right;'>&emsp;Manque d'information !</label> ";    
  }
}   
?>
<!DOCTYPE html>
...
<body id="page-top">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Nouveau Activités</h4>
                  
                  <form method="post" class="form" id="form" enctype="multipart/form-data" >
                 
             
            <div class="input-group mb-3">
            <label class="col-sm-3 col-form-label ">Id Activite</label>
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="id_a" id="id_a" placeholder= "Id Activite ">
                   <a id="test3"></a>
                </div>
            </div>
            <br>
            ...
            <label class="col-sm-3 col-form-label ">Titre Activite</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="titre_a" id="titre_a" placeholder= "Titre Activite">
                    <a id="test1"></a>
                </div>
            </div>
            </div>
            ...
            <label class="col-sm-3 col-form-label ">description Activite</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="description_a" id="description_a" placeholder= "description Activite">
                    <a id="test1"></a>
                </div>
            </div>
            </div>
            ...
            <label class="col-sm-3 col-form-label ">Categorie Activite</label>
                <div class="col-sm-6">
                <select class="form-control" name="categorie_a" id="categorie_a" placeholder= "Categorie Activite">
            ...
            <label class="col-sm-3 col-form-label ">Prix Activite</label>
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="prix_a" id="prix_a" placeholder= "Prix Activite">
                    <a id="test1"></a>
                </div>
            </div>
            </div>
            ...
            <label class="col-sm-3 col-form-label ">Date Activite</label>
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="date_a" id="date_a" placeholder= "Date Activite">
                    <a id="test1"></a>
                </div>
            </div>
            </div>
    ...
    form.addEventListener('submit', function(event) {
        ...
        const idValid = document.getElementById('id_a').value;
        const prixValid = document.getElementById('prix_a').value;
        const dateValid = document.getElementById('date_a').value;
        messagesDiv.innerHTML = '';
        let isValid = true;
        if (!/^\d{6}$/.test(idValid)) {
            afficherMessage(document.getElementById('id_a'), 'Id doit contenir exactement 6 chiffres');
            isValid = false;
        }
