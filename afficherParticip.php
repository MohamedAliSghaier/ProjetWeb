        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                 <div class="card">
                 <div class="card-body">
                 <h4 class="card-title">Listes Participation</h4>
                 ...
                 <a class="btn btn-primary" href="ajouterParticip.php" role="button">Nouveau Participation</a>
                 <br>
                 ...
                 <p></p>
		          ...
		          <thead>
			        ...
			        <?php
				      foreach($listeParticip as $Particip){
			        ?>
			       <tr>
	         		 <td><?php echo $Particip['id_p']; ?></td>
                     <td><?php echo $Particip['statut']; ?></td>
	      			 <td><?php echo $Particip['titre_a']; ?></td>
				     <td>	
                     <form method="GET" action="modifierParticip.php">
					 <input type="submit"  class="btn btn-primary btn-sm" name="Modifier" value="Modifier">
					 <input type="hidden"  value=<?php echo $Particip['id_p']; ?>  name="id_p">  
					 </form>
				     </td>
				     <td>
					 <a  class="btn btn-danger btn-sm"   href="supprimerParticip.php?id_a=<?php echo $Particip['id_p']; ?>">Supprimer</a>
				     </td>
			       </tr>
			     <?php
				 }
