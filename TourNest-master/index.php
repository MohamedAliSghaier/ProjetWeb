...
if(isset($_POST['submit']))
{
    ...
    $query= mysqli_query($con,"insert into product (Id,Name,Price) values ('$Id','$Name','$Price')");
}
              ...
              <div class="main-menu">
                ...
                <div class="collapse navbar-collapse">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="smooth-menu"><a href="#blog">Shop</a></li>
                    <li class="smooth-menu">
                        ...
                        <div class="single-trip-circle">
                          ...
                          <label for="radio01">
                            <span class="round-boarder">
                              <span class="round-boarder1"></span> </span
                            >round trip
                          </label>
                        </div>
                        <!--/.single-trip-circle-->
                ...
                <div class="single-special-offer-txt">
                  ...
                  <div class="packages-para special-offer-para">
                    <p>
                      ...
                      <span> <i class="fa fa-angle-right"></i> 2 person </span>
                      <span>
                        <i class="fa fa-angle-right"></i> 5 star accomodation
                      </span>
                    </p>
                    ...
                    <p class="offer-para">
                      ...
                      enim ad minim veniam, quis nostrud exercitation una <br />
    ...
    <section id="blog" class="blog">
      <div class="container">
        <div class="blog-details">
          <div class="gallary-header text-center">
            <h2>Our Shop</h2>
            <p>Explore Our Best Collection Of Our Limited Items</p>
          </div>
          <!--/.gallery-header-->
                  ...
                  <div class="caption">
                    <div class="blog-txt">
                      ...
                      <button class="btn btn-primary my-5">
                        <a href="../shop/shop.php" class="text-light"
                          >Purchase</a
                        >
                      </button>
                    </div>
