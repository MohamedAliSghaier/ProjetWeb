...
if (		
  ...
  if (  !empty($_POST["statut"]) && !empty($_POST["activite"]))
  {
    ...
    $id_activite = $activiteC->getIdByType($activiteTitre); 
      $particips = new Particip
      ($_GET["id_p"],$_POST["statut"],$id_activite);
      $participc->Modifierp($particips,$_GET["id_p"]);
        header("Location: afficherParticip.php?mess=Participation modifie avec succes");
        exit(); 
  }
    else
    echo $error = "<label id = 'form' style = 'color: red; font-weight: bold; text-align: center; display: flex;float: right;'>&emsp;Manque d'information !</label> ";  
}   
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <a class="nav-link" href="afficherParticip.php">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Modifier Participation</h4>
                  
                  <?php
			if (isset($_GET['id_p'])){
				$particips = $participc->Recupererp($_GET['id_p']);
		...
		?>
            ...
            <label class="col-sm-3 col-form-label ">Statut Participation</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="statut" id="statut" value="<?php echo $particips['statut'];?>" >
                </div>
            </div>
